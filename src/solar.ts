 ...
 */
export const lYearDays = function (y: number): number {
    var i, sum = 348;
 ...
 */
export const leapDays = function (y: number): number {
    if (leapMonth(y)) {
 ...
 */
export const monthDays = function (y: number, m: number): number {
    if (m > 12 || m < 1) {
        return -1;
    }//月份参数从1至12，参数错误返回-1
...
*/
export const solarDays = function (y: number, m: number) {
    if (m > 12 || m < 1) {
        return -1;
    } //若参数错误 返回-1
    var ms = m - 1;
...
* @return Cn string
*/
export const toGanZhi = function (offset: number): string {
...
*/
export const getTerm = function (y: number, n: number): number {
    if (y < 1900 || y > 2100) {
        return -1;
    }
    if (n < 1 || n > 24) {
 ...
 * @eg:
 */
export const toChinaYear = function (y: number): string { //年 => \u5E74
...
*/
export const toChinaMonth = function (m: number): string | number { // 月 => \u6708
    if (m > 12 || m < 1) {
        return -1;
    } //若参数错误 返回-1
    var s = nStr3[m - 1];
 ...
 */
export const toChinaDay = function (d: number): string { //日 => \u65e5
    var s;
    switch (d) {
        case 10:
            s = '\u521d\u5341';
 ...
 * todo 生肖需要精确转换
 */
export const getAnimal = function (y: number): string {
   ...
   */
  export const leapMonth=function (y:number):number { //闰字编码 \u95f0
 ...
 */
export const solar2lunar = function (y: number, m: number, d: number): Solar2lunar | number { //参数区间1900.1.31~2100.12.31
    if (y < 1900 || y > 2100) {
        return -1;
    }//年份限定、上限
    if (y == 1900 && m == 1 && d < 31) {
...
*/
export const lunar2solar = function (y: number, m: number, d: number, isLeapMonth: boolean): Solar2lunar | number {	//参数区间1900.1.31~2100.12.1
    var leapOffset = 0;
    var leapMonth1 = leapMonth(y);
